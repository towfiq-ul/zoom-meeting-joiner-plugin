...
| Screenshot ×1+ | 1280×800 or 640×400 (Chrome/Edge) | **manual** — screenshot the popup right after a scan (result fields visible) |
| Small promo tile | 440×280 (Chrome only) | **manual** |
